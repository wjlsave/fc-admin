...
http.post = function(url, data, options={isShowLoading : true,successMessage : "操作成功"},errorMethod) {
	let loadinginstance;
...
http.get = function(url, data, options={isShowLoading : false,successMessage : ""}) {
	let loadinginstance;
	if (options.isShowLoading !== false) {
	    loadinginstance = Loading.service({ fullscreen: true });
	}
